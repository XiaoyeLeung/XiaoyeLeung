...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'XiaoyeLiang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'HumanObserver', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiaoye-leung-kappa.vercel.app', // 网站地址
